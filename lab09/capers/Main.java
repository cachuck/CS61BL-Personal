...
public class Main {
    ...
    public static void setupPersistence() {
        ...
        if (!STORY_FILE.exists()){
            ...
            } catch (IOException storyExcep){
                System.out.println("Error in story file creation.");
            }
        }
    }
    ...
    public static void writeStory(String[] args) {
        ...
        String old_content = Utils.readContentsAsString(STORY_FILE);
        Utils.writeContents(STORY_FILE, old_content + '\n' + args[1]);
    ...
    public static void makeDog(String[] args) {
        ...
        Dog doge = new Dog(args[1], args[2], Integer.parseInt(args[3]));
        doge.saveDog();
